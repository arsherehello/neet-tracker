...
public class MainActivity extends Activity {
    ...
    private LinearLayout buildHeader() {
        ...
        // ---- donut row: per-subject completion, beside the countdown ----
        ...
        LinearLayout.LayoutParams donutLp = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        ...
        LinearLayout.LayoutParams scColLp = new LinearLayout.LayoutParams(0, ViewGroup.LayoutParams.WRAP_CONTENT, 1f);
        scColLp.leftMargin = dp(10);
        ...
        scCol.addView(countdownTitle);

        // countdown row, beside the rings
        ...
        scCol.addView(countdownRow);

        // streak, on its own row below the countdown so it always has full width to render on one line
        ...
        LinearLayout.LayoutParams streakRowLp = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        streakRowLp.topMargin = dp(6);
        streakRow.setLayoutParams(streakRowLp);

        streakNum = new TextView(this);
        streakNum.setTextColor(CORAL);
        streakNum.setTextSize(16);
        streakNum.setTypeface(Typeface.DEFAULT_BOLD);
        streakNum.setSingleLine(true);
        streakRow.addView(streakNum);
    ...
    private LinearLayout buildTestsTab() {
        ...
        final EditText nameInput = styledInput("Test name (e.g. Full Syllabus Mock 3)");
        formCard.addView(nameInput, fieldLp());
        ...
        dateInput.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                try {
                    ...
                    cal.setTime(fmt.parse(dateInput.getText().toString()));
            ...
            public void run() {
                ...
                for (int i = tests.length() - 1; i >= 0; i--) {
                    ...
                    if (name != null && name.trim().length() > 0) {
                        TextView nameLine = new TextView(MainActivity.this);
                        nameLine.setText(name);
                        nameLine.setTextColor(INK);
                        nameLine.setTypeface(Typeface.DEFAULT_BOLD);
                        nameLine.setTextSize(13.5f);
                        infoCol.addView(nameLine);
                    }

                    TextView dateLine = new TextView(MainActivity.this);
                    dateLine.setText(t.optString("date"));
                    dateLine.setTextColor(name != null && name.trim().length() > 0 ? MUTED : INK);
                    dateLine.setTypeface(name != null && name.trim().length() > 0 ? Typeface.DEFAULT : Typeface.DEFAULT_BOLD);
                    dateLine.setTextSize(name != null && name.trim().length() > 0 ? 11.5f : 13.5f);
        ...
        addBtn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                try {
                    store.addTest(name, date, Double.parseDouble(scoreStr), 720.0);
                    nameInput.setText("");
                    scoreInput.setText("");
                    refresh[0].run();
