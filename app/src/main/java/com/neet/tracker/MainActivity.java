...
public class MainActivity extends Activity {
    ...
    private LinearLayout buildHeader() {
        ...
        // countdown + streak side by side, both beside the rings
        ...
        bottomRow.addView(countdownRow);
        ...
        streakLabel.setTextSize(9);
        streakBlock.addView(streakLabel);
        bottomRow.addView(streakBlock);

        scCol.addView(bottomRow);
